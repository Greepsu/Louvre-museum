...
//import assets
import visitImg from "../../assets/images/Viktor.jpg";
  ...
  return (
    <div className="visit" ref={ref}>
      ...
      <div className="visit-img">
        <img src={visitImg} alt="Viktor Barvitius painting" />
      </div>
      <div className="visit-container">
        ...
        <div className="visit-admissions">
          ...
          <div className="visit-opening-price">
            ...
            <span className="container-end">220 CZK</span>
          </div>
          <div className="visit-opening-price">
            <span className="container-start">Reduced</span>
            <span className="container-end">120 CZK</span>
          </div>
          <div className="visit-opening-price">
